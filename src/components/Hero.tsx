...
with HAMII Intelligence
        ...
        animationDelay: "0.4s"
          ...
          <Button size="lg" onClick={() => window.location.href = '/practice'} className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-glow-primary text-lg px-8 py-6">
            Start Practicing Free
            <ArrowRight className="ml-2 w-5 h-5" />
          </Button>
           <Button size="lg" variant="outline" onClick={() => window.location.href = '/hr-interview'} className="border-border hover:bg-secondary text-lg px-8 py-6">
             <Users className="mr-2 w-5 h-5" />
             HR Interview Practice
          </Button>
        </div>

        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto animate-fade-in" style={{
        animationDelay: "0.6s"
      }}>
